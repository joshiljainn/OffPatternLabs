        ...
        <section id="contact" className="py-12 md:py-20 px-4 bg-transparent">
            <div className="w-full max-w-5xl mx-auto bg-[#FDFBF7] border-2 border-[#111] shadow-[8px_8px_0px_#111] rounded-[24px] p-8 md:p-16 relative z-10 text-center overflow-hidden">
                ...
                <p
                    ...
                    style={{ color: "#0B132B", opacity: 0.72 }}
                >
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                    <Link href="#audit" className="btn-retro-orange">
                        Get Your Free Valuation
                    </Link>
                    <a
                        href="https://wa.me/918076958506?text=Hi! I'd like to talk about revivivng my newsletter."
                        target="_blank"
                        rel="noopener noreferrer"
                        className="btn-retro-navy inline-flex items-center justify-center"
                    >
                        Chat on WhatsApp
                    </a>
                </div>
