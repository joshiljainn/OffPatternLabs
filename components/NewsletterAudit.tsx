...
export default function NewsletterAudit() {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        const message = `Hi! I'd like to get an audit for my newsletter.
    
Newsletter URL: ${url}
Approximate Subscribers: ${subscribers}
            ...
            <div className="w-full max-w-5xl mx-auto bg-[#0B132B] border-2 border-[#111] shadow-[8px_8px_0px_#111] rounded-[24px] p-8 md:p-16 relative z-10">
                <div className="text-center mb-12">
                    <h2
                        ...
                        style={{ color: "#FDFBF7", fontSize: "clamp(1.6rem, 3.5vw, 2.8rem)" }}
                    >
                        How Much is Your Dead List Worth?
                    </h2>
                    <p
                        className="max-w-2xl mx-auto text-lg leading-relaxed"
                        style={{ color: "#FDFBF7", opacity: 0.65 }}
                    >
                        Stop guessing. Get a free, confidential audit of your newsletter. We&apos;ll analyze
                        your niche, metrics, and dormant subscriber count to give you a concrete
                        valuation and a plan to revive it.
                    </p>
                </div>

                <div
                    className="max-w-xl mx-auto p-8 rounded-[16px] border-2"
                    style={{
                        background: "#0B132B",
                        borderColor: "#E07A5F",
                        boxShadow: "8px 8px 0px #E07A5F",
                    }}
                >
                    <form className="space-y-6" onSubmit={handleSubmit}>
                        ...
                        <div>
                            ...
                            <select
                                id="subscribers"
                                className="w-full rounded-[10px] px-4 py-3 text-sm outline-none cursor-pointer"
                                style={{
                                    background: "#FDFBF7",
                                    border: "2px solid #111",
                                    color: "#0B132B",
                        ...
                        <button
                            type="submit"
                            className="btn-retro-orange w-full text-center"
